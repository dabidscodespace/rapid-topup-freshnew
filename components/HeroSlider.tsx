...
const slides = [
  ...
  {
    id: 4, // Fixed duplicate ID from 2 to 4
    badge: "⚡ HIGH SCORE",
    title: "FREE FIRE DIAMONDS",
    subtitle: "LEVEL UP YOUR GAMEPLAY WITH INSTANT DIAMOND TOP-UPS.",
    price: "FROM ৳50",
    ...
    <div className="relative w-full py-8 sm:py-12 overflow-hidden">
      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id} className="!h-auto">
            ...
            >
              {/* Added min-h-[300px] for mobile readability, sm:min-h-0 lets aspect-ratio take over on larger screens */}
              <div
              ...
              >
                ...
                {/* Added pointer-events-none to prevent overlay from blocking clicks */}
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="transform transition-transform duration-200 group-hover:translate-y-[-2px]">
                    ...
                    {/* Added line-clamp to prevent text overflow on small screens */}
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 md:gap-6 mt-2 sm:mt-0">
                      ...
                      {/* Added whitespace-nowrap to prevent button text from breaking */}
      ...
      <style jsx global>{`
        .mySwiper .swiper-slide {
          ...
          height: auto !important; /* Ensures Swiper respects our min-h and aspect-ratio */
        }
